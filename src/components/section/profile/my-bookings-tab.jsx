    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
            <Label htmlFor="search">Search by ID or Flight</Label>
            <Input
              id="search"
              placeholder="Enter booking ID or flight number"
              value={searchTerm}
            ...
            <div className="flex items-center space-x-1">
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                <Button
                  ...
                  className={`w-8 h-8 p-0 ${currentPage === page ? "bg-blue-600 hover:bg-blue-700" : ""}`}
                >
                  {page}
                </Button>
              ))}
