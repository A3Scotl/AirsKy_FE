...
//     // Tạo URLSearchParams tương tự như trong HomePage
//     const params = new URLSearchParams();
//     params.append(
//       "from",
//       `${originalFlight.departureAirport.city} (${originalFlight.departureAirport.airportCode})`
//     );
//     params.append(
//       "to",
//       `${originalFlight.arrivalAirport.city} (${originalFlight.arrivalAirport.airportCode})`
//     );
//     params.append("departDate", originalFlight.departureDate);
//     params.append("tripType", "ONE_WAY");
//     params.append(
//       "passengers",
//       JSON.stringify({ adults: 1, children: 0, infants: 0 })
//     );

//     // Lưu dữ liệu tìm kiếm vào localStorage để trang /flights có thể sử dụng
//     localStorage.setItem("searchData", JSON.stringify(originalFlight));
...
//       try {
//         setLoading(true);
//         const response = await flightApi.searchUnifiedFlights({
//           departureAirportId: 1, // SGN
//           arrivalAirportId: 2, // HAN
//           outboundDepartureDate: formattedDate,
//           tripType: "ONE_WAY",
